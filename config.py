...
}, show_at_tab=False, icon=Icon.GAME)
...
config = {
    ...
    'custom_tabs': [
        ...
        ["src.gui.DeveloperTab", "DeveloperTab"],
    ],
    'ocr': {
        'lib': 'onnxocr',
        'auto_simplify': True,
    ...
    'links': {
        'default': {
            'github': 'https://github.com/etg227/wuwa-yg-launcher',
            'share': 'Download 椰果启动器 from https://github.com/etg227/wuwa-yg-launcher/releases',
            'faq': 'https://github.com/etg227/wuwa-yg-launcher/issues'
        },
        'zh_CN': {
            'github': 'https://github.com/etg227/wuwa-yg-launcher',
            'share': '下载 椰果启动器 https://github.com/etg227/wuwa-yg-launcher/releases',
            'faq': 'https://github.com/etg227/wuwa-yg-launcher/issues',
        },
    },
    'about': """
